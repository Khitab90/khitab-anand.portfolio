...
export default function Hero() {
  ...
  const handleMouseMove = useCallback((e: React.MouseEvent<HTMLElement>) => {
    ...
    if (profileContainerRef.current && profileRevealRef.current) {
      ...
      // Only reveal when cursor is near the profile container
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-[1100px] mx-auto px-8 w-full grid md:grid-cols-2 gap-16 items-center py-24">
        ...
        >
          {/* Eyebrow */}
          <p className="font-heading text-[#a2e7ff] font-semibold tracking-widest uppercase mb-6 text-sm">
            Frontend Architect
          </p>

          {/* Main heading — large editorial style */}
          <h1 className="font-heading text-6xl md:text-8xl font-bold tracking-tighter leading-none mb-8">
            Khitab{' '}
          ...
          {/* Subtitle */}
          <p className="text-lg text-[#918fa1] max-w-xl mb-12 leading-relaxed mx-auto md:mx-0">
        ...
        {/* Right: profile photo with reveal effect */}
        <motion.div
        ...
        >
          ...
          >
            ...
            />
            {/* Sharp reveal image — follows cursor */}
            <img
